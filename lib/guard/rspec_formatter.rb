...
module Guard
  class ChefSpecFormatter < ::RSpec::Core::Formatters::BaseFormatter
    WIKI_ENV_WARN_URL =
    ...
    def _results_file
      path = ENV["GUARD_CHEF_RESULTS_FILE"]
      if path.nil?
        STDERR.puts "Guard::Chef: Warning: #{NO_ENV_WARNING_MSG}\n" \
          "Guard::Chef: Warning: #{NO_RESULTS_VALUE_MSG}"
